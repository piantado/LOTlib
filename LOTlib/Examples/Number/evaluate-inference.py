...
def run_one(prefix, s):
	...
	elif s == 'parallel_tempering_A':    sampler = parallel_tempering_sample(generate_h0, data, steps=options.SAMPLES, within_steps=10, temperatures=[1.0, 1.025, 1.05], swaps=1, yield_all=True)
	elif s == 'parallel_tempering_B':    sampler = parallel_tempering_sample(generate_h0, data, steps=options.SAMPLES, within_steps=10, temperatures=[1.0, 1.05, 1.1], swaps=1, yield_all=True)
	elif s == 'parallel_tempering_C':    sampler = parallel_tempering_sample(generate_h0, data, steps=options.SAMPLES, within_steps=10, temperatures=[1.0, 1.25, 1.5], swaps=1, yield_all=True)
