...
if __name__ == '__main__':
    ...
    rec = probe_MHsampler(make_hypothesis('AnBn'), language.sample_data_as_FuncData, options, 'skewed_out_' + str(rank) + suffix)
    ...
    rec1 = probe_MHsampler(make_hypothesis('AnBn'), language.sample_data_as_FuncData, options, 'normal_out' + str(rank) + suffix, data=[FunctionData(input=[], output=cnt)])