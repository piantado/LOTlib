"""
class to test RegularExpressionInferece.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Examples.RegularExpressionLearner.RegularExpressionInferece import *
class RegularExpressionInfereceTest(unittest.TestCase):
