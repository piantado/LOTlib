"""
class to test DecayedLikelihoodHypothesis.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Hypotheses.DecayedLikelihoodHypothesis import *
class DecayedLikelihoodHypothesisTest(unittest.TestCase):
