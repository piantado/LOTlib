...
class SimpleEnglish0(FormalLanguage):
    """
    ...
    def __init__(self):
        ...
        # self.grammar.add_rule('VP', 'vt%s', ['S'], 0.50)
        # self.grammar.add_rule('S', 'i%sh%s', ['S','S'], 0.10) # add if S then S grammar

    def terminals(self):
        return list('dnavtih')

class SimpleEnglish1(FormalLanguage):
    """
    A simple English language with a few kinds of recursion all at once
    """
...
class SimpleEnglish2(FormalLanguage):
    """
    A simple English language with a few kinds of recursion all at once
    """
