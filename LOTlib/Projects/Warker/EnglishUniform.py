...
parser = OptionParser()
parser.add_option("-f", "--file", dest="filename", help="file name of the pickled results", default="FirstEnglishUniform.pkl")
...
grammar.add_rule('TERMINAL', 't', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'r', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'l', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 's', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'd', None, TERMINAL_WEIGHT)
...
grammar.add_rule('TERMINAL', 'z', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'v', None, TERMINAL_WEIGHT)

grammar.add_rule('TERMINAL', 'p', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'w', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'b', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'f', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'y', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'g', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'h', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'S', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'N', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'j', None, TERMINAL_WEIGHT)
grammar.add_rule('TERMINAL', 'T', None, TERMINAL_WEIGHT)
