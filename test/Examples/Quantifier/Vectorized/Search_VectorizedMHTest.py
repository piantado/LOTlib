"""
class to test Search_VectorizedMH.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Examples.Quantifier.Vectorized.Search_VectorizedMH import *
class Search_VectorizedMHTest(unittest.TestCase):
