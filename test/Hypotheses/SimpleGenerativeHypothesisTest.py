"""
class to test SimpleGenerativeHypothesis.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Hypotheses.SimpleGenerativeHypothesis import *
class SimpleGenerativeHypothesisTest(unittest.TestCase):
