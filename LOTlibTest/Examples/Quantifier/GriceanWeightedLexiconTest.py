"""
class to test GriceanWeightedLexicon.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Examples.Quantifier.GriceanWeightedLexicon import *
class GriceanWeightedLexiconTest(unittest.TestCase):
