...
def log_probability(tree):
	ls = tree.as_list()
	# the total log probability is just the sum of the log probabilities of each part of the tree
	log1 = log_probability_A(ls[1])
	log2 = 0
	if len(ls) == 3: log2 = log_probability_B(ls[2])
	return log1 + log2
