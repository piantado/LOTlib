"""
class to test RationalRulesLOTHypothesis.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Hypotheses.RationalRulesLOTHypothesis import *
class RationalRulesLOTHypothesisTest(unittest.TestCase):
