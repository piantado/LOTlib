"""
class to test Number_evaluate_samplers.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Evaluation.EvaluateNumber.Number_evaluate_samplers import *
class Number_evaluate_samplersTest(unittest.TestCase):
