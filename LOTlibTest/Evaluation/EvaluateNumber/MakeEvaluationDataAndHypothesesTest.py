"""
class to test MakeEvaluationDataAndHypotheses.py
follows the standards in https://docs.python.org/2/library/unittest.html
"""

import unittest

from LOTlib.Evaluation.EvaluateNumber.MakeEvaluationDataAndHypotheses import *
class MakeEvaluationDataAndHypothesesTest(unittest.TestCase):
